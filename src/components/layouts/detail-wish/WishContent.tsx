...
const WishContent: FC<IProps> = ({ wish }) => {
    ...
    return (
        <div
            className={`${wish.images.length > 1 ? 'mt-[100px] tablet-md:mt-[120px] desktop-xs:mt-0' : ''} flex w-full flex-col gap-4 pl-4 pr-3 tablet-md:pl-5 tablet-lg:pl-8 tablet-lg:pr-5 desktop-xs:col-span-5 desktop-xs:gap-6 desktop-xs:pr-8`}
        >
