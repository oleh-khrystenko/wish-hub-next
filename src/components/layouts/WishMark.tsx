...
const WishMark: FC<IProps> = ({
    ...
    return (
        <>
            ...
            {wish.booking?.end && (
                <span
                    className={`${classes} worn-out whitespace-nowrap rounded-md border-2 border-solid border-rose-500 px-1 text-xs font-bold uppercase text-rose-500 backdrop-blur mobile-md:px-2 mobile-md:py-0.5 mobile-xl:text-sm tablet-sm:px-2 tablet-sm:py-1 tablet-sm:text-base tablet-md:text-xl desktop-md:text-2xl`}
                >
