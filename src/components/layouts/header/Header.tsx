...
const Header: FC<IProps> = ({ isMainPage }) => {
    return (
        <header
            className={`${isMainPage ? 'hidden tablet-md:block tablet-md:p-0' : 'mx-auto block max-w-7xl desktop-sm:p-0'} sticky top-0 z-40 w-full rounded-b-lg bg-zinc-200 px-1 pt-1 dark:bg-zinc-900`}
        >
            <div
