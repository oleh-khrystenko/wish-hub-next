...
const Header: FC<IProps> = ({ isMainPage }) => {
    return (
        <header
            className={`${isMainPage ? 'hidden tablet-md:block' : 'mx-auto block max-w-7xl'} sticky -top-px z-40 w-full rounded-b-lg bg-zinc-200 px-1 pt-1 dark:bg-zinc-900 desktop-sm:px-0`}
        >
            <div
