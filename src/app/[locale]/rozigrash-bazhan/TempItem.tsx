...
const TempItem: FC<IProps> = ({ count, title, text }) => {
    return (
        <li className="relative flex items-center gap-4 rounded-3xl bg-zinc-300 bg-[url('/images/sing-up-bg.webp')] bg-cover bg-center bg-no-repeat p-6 before:absolute before:inset-0 before:-z-10 before:-rotate-2 before:rounded-3xl before:border before:border-dashed before:border-zinc-400 dark:bg-zinc-800 before:dark:border-zinc-600 tablet-md:gap-6 tablet-md:px-8 tablet-md:py-6 tablet-md:before:-rotate-1">
