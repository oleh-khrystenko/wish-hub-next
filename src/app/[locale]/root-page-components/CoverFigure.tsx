...
const CoverFigure: FC = () => {
    ...
    return (
        <div className="relative mx-auto mt-16 w-48 rounded-xl bg-zinc-400 px-2 py-3 dark:bg-zinc-900 mobile-xs:w-56 mobile-sm:w-60 mobile-md:w-[266px] tablet-md:mt-40 tablet-md:w-[438px] tablet-md:rounded-3xl tablet-md:p-4 desktop-sm:row-span-2 desktop-sm:ml-20 desktop-sm:mr-[70px] desktop-sm:mt-auto desktop-sm:translate-y-8">
            ...
            {/* arrow-1 */}
            <div className="absolute bottom-9 left-0 h-7 w-7 -translate-x-full rotate-180 animate-appear-17 opacity-0 mobile-sm:bottom-10 mobile-sm:h-8 mobile-sm:w-8 mobile-md:h-9 mobile-md:w-9 tablet-md:-left-2 tablet-md:bottom-[90px] tablet-md:h-16 tablet-md:w-16">
                <Image
            ...
            {/* arrow-2 */}
            <div className="absolute left-2 top-11 h-8 w-8 -translate-x-full -rotate-[70deg] animate-appear-2 opacity-0 mobile-md:h-9 mobile-md:w-9 tablet-md:left-2.5 tablet-md:h-16 tablet-md:w-16">
                <Image
                    src="/images/arrow.webp"
                    alt={welcomePageT('alts.arrow')}
                    fill
            ...
            {/* arrow-3 */}
            <div className="absolute left-24 top-4 h-7 w-7 -translate-y-full -rotate-[70deg] animate-appear-11 opacity-0 mobile-xs:left-28 mobile-sm:left-32 mobile-sm:h-8 mobile-sm:w-8 mobile-md:left-36 mobile-md:top-3 mobile-md:h-9 mobile-md:w-9 tablet-md:left-[234px] tablet-md:top-7 tablet-md:h-16 tablet-md:w-16">
                <Image
                    src="/images/arrow.webp"
                    alt={welcomePageT('alts.arrow')}
                    fill
            ...
            {/* arrow-4 */}
            <div className="absolute -right-1 top-10 h-7 w-7 translate-x-full animate-appear-15 opacity-0 mobile-sm:right-0 mobile-sm:h-8 mobile-sm:w-8 mobile-md:h-9 mobile-md:w-9 tablet-md:-right-3.5 tablet-md:top-[70px] tablet-md:h-16 tablet-md:w-16">
                <Image
                    src="/images/arrow.webp"
                    alt={welcomePageT('alts.arrow')}
                    fill
            ...
            {/* arrow-5 */}
            <div className="absolute bottom-12 right-2 h-7 w-7 translate-x-full rotate-[110deg] animate-appear-7 opacity-0 mobile-sm:h-8 mobile-sm:w-8 mobile-md:h-9 mobile-md:w-9 tablet-md:bottom-24 tablet-md:h-16 tablet-md:w-16">
                <Image
                    src="/images/arrow.webp"
                    alt={welcomePageT('alts.arrow')}
                    fill
