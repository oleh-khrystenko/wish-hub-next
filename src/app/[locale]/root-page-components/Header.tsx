    ...
    return (
        <header className="-ml-4 flex items-center justify-between gap-4 py-4 tablet-md:px-0 tablet-md:py-6">
            ...
            <div className="flex items-center gap-10">
                ...
                <div className="fixed inset-x-0 bottom-0 z-40 flex flex-wrap justify-around gap-2 bg-zinc-100 px-3.5 py-2 dark:bg-zinc-900 mobile-xs:items-center mobile-xs:justify-between mobile-sm:gap-4 mobile-sm:px-4 tablet-md:static tablet-md:bg-transparent tablet-md:p-0 tablet-md:dark:bg-transparent">
                    <LangSelect
