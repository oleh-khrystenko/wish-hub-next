...
function Sidebar() {
    ...
    return (
        <div
            className={`${showSidebar ? 'scale-x-100' : 'scale-x-0'} fixed bottom-16 left-0 top-0 z-30 flex w-full origin-left scale-x-0 flex-col bg-zinc-300 p-3 transition-all duration-300 ease-in-out dark:bg-zinc-800 tablet-md:static tablet-md:w-1/3 tablet-md:scale-x-100 tablet-md:rounded-r-lg tablet-xl:w-1/4`}
        >
